...
template <raft_rpc::one_way_kind rpc_kind, typename Verb, typename Msg>
void raft_rpc::one_way_rpc(sloc loc, raft::server_id id,
        Verb&& verb, Msg&& msg) {
...
auto raft_rpc::two_way_rpc(sloc loc, raft::server_id id,
        Verb&& verb, Args&&... args) {
