...
strongly_consistent_select_statement::execute_without_checking_exception_message(query_processor& qp, service::query_state& qs, const query_options& options, service::group0_guard* guard) const {
    if (this_shard_id() != 0) {
