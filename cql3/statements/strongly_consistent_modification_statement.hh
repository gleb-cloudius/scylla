...
public:
    ...
    execute(query_processor& qp, service::query_state& qs, const query_options& options, service::group0_guard* guard) const override;

    virtual future<::shared_ptr<cql_transport::messages::result_message>>
    execute_without_checking_exception_message(query_processor& qp, service::query_state& qs, const query_options& options, service::group0_guard* guard) const override;
