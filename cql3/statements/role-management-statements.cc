...
future<result_message_ptr>
alter_role_statement::execute(query_processor&, service::query_state& state, const query_options&, service::group0_guard* guard) const {
...
future<result_message_ptr>
drop_role_statement::execute(query_processor&, service::query_state& state, const query_options&, service::group0_guard* guard) const {
    auto& as = *state.get_client_state().get_auth_service();
...
future<result_message_ptr>
list_roles_statement::execute(query_processor&, service::query_state& state, const query_options&, service::group0_guard* guard) const {
...
future<result_message_ptr>
grant_role_statement::execute(query_processor&, service::query_state& state, const query_options&, service::group0_guard* guard) const {
    auto& as = *state.get_client_state().get_auth_service();
